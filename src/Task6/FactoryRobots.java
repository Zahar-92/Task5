...
public class FactoryRobots {
   FactoryBody factoryBody = new FactoryBody();
    ...
    String[] NAMESROBOT = new String[]{"R2-D2", "Боевой дроид B1", "МагнаСтраж IG-100", "EV-9D9",
    ...
    public void makeRobot() {
        for (int i = 0; i < 9; i++) {
            ...
            robots[i] = "Модель робота: " + NAMESROBOT[i] + ", состоит из следующих частей: Название головы: " + head +
                    ", Название тела: " + body;
        }
        print();
    }
